# -----------------------------------------------------------------------------
# DEPS file for glsl-optimizer scaffold
# =========================================
# -----------------------------------------------------------------------------

# This file is used to manage the dependencies of the
# glsl-optimizer-scaffold scaffold repo.
...
deps = {
  ...
  # this
  # line
  'glsl-optimizer': 'https://github.com/aras-p/glsl-optimizer.git@{glsl-optimizer_revision}',
  # keep
  # this
  # line
}
